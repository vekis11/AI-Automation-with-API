...
from main import app, APILog, AnomalyDetectionRequest, TrainingData, extract_features
    ...
    def test_detect_anomalies_success(self, trained_model):
        ...
        with patch('main.extract_features') as mock_extract:
            mock_extract.return_value = pd.DataFrame({
                'hour': [1, 2, 3, 4, 5],
                'status_code': [200, 500, 200, 500, 200],
                'response_time': [0.1, 5.0, 0.2, 4.0, 0.1]
            })
...
class TestModelStatus:
    ...
    def test_model_status_trained(self):
        ...
        with patch('main.is_trained', True), \
             patch('main.scaler') as mock_scaler:
...
class TestModelLoading:
    ...
    def test_load_model_exception(self):
        ...
        with patch('main.os.path.exists', return_value=True), \
             patch('main.joblib.load', side_effect=Exception("Load failed")):
...
class TestPerformance:
    ...
    def test_large_dataset_handling(self):
        ...
        with patch('main.joblib.dump'), \
             patch('main.extract_features') as mock_extract:
